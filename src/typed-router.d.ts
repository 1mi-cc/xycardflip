...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/card-flip-ops/ValidationInsightsPanel': RouteRecordInfo<'/card-flip-ops/ValidationInsightsPanel', '/card-flip-ops/ValidationInsightsPanel', Record<never, never>, Record<never, never>>,
    ...
    '/SupportTickets': RouteRecordInfo<'/SupportTickets', '/SupportTickets', Record<never, never>, Record<never, never>>,
