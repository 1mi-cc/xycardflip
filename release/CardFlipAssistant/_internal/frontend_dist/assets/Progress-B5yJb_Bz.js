import{k as B,n as m,bv as _,D as r,at as W,bw as j,bx as q,by as O,bz as G,Y as z,$ as a,a0 as w,K as A,a6 as T,bA as L,av as N,a9 as M}from"./index-BSMS5bAg.js";import{f as k}from"./format-length-B-p6aW7q.js";const X={success:r(G,null),error:r(O,null),warning:r(q,null),info:r(j,null)},Y=B({name:"ProgressCircle",props:{clsPrefix:{type:String,required:!0},status:{type:String,required:!0},strokeWidth:{type:Number,required:!0},fillColor:[String,Object],railColor:String,railStyle:[String,Object],percentage:{type:Number,default:0},offsetDegree:{type:Number,default:0},showIndicator:{type:Boolean,required:!0},indicatorTextColor:String,unit:String,viewBoxWidth:{type:Number,required:!0},gapDegree:{type:Number,required:!0},gapOffsetDegree:{type:Number,default:0}},setup(e,{slots:u}){const g=m(()=>{const o="gradient",{fillColor:t}=e;return typeof t=="object"?`${o}-${_(JSON.stringify(t))}`:o});function y(o,t,n,d){const{gapDegree:p,viewBoxWidth:f,strokeWidth:h}=e,l=50,b=0,s=l,i=0,x=2*l,$=50+h/2,v=`M ${$},${$} m ${b},${s}
 ...
 `)]),K=Object.assign(Object.assign({},T.props),{processing:Boolean,type:{type:String,default:"line"},gapDegree:Number,gapOffsetDegree:Number,status:{type:String,default:"default"},railColor:[String,Array],railStyle:[String,Array],color:[String,Array,Object],viewBoxWidth:{type:Number,default:100},strokeWidth:{type:Number,default:7},percentage:[Number,Array],unit:{type:String,default:"%"},showIndicator:{type:Boolean,default:!0},indicatorPosition:{type:String,default:"outside"},indicatorPlacement:{type:String,default:"outside"},indicatorTextColor:String,circleGap:{type:Number,default:1},height:Number,borderRadius:[String,Number],fillBorderRadius:[String,Number],offsetDegree:Number}),Q=B({name:"Progress",props:K,setup(e){const u=m(()=>e.indicatorPlacement||e.indicatorPosition),g=m(()=>{if(e.gapDegree||e.gapDegree===0)return e.gapDegree;if(e.type==="dashboard")return 75}),{mergedClsPrefixRef:y,inlineThemeDisabled:c}=A(e),o=T("Progress","-progress",F,L,e,y),t=m(()=>{const{status:d}=e,{common:{cubicBezierEaseInOut:p},self:{fontSize:f,fontSizeCircle:h,railColor:l,railHeight:b,iconSizeCircle:s,iconSizeLine:i,textColorCircle:x,textColorLineInner:$,textColorLineOuter:v,lineBgProcessing:C,fontWeightCircle:S,[N("iconColor",d)]:R,[N("fillColor",d)]:P}}=o.value;return{"--n-bezier":p,"--n-fill-color":P,"--n-font-size":f,"--n-font-size-circle":h,"--n-font-weight-circle":S,"--n-icon-color":R,"--n-icon-size-circle":s,"--n-icon-size-line":i,"--n-line-bg-processing":C,"--n-rail-color":l,"--n-rail-height":b,"--n-text-color-circle":x,"--n-text-color-line-inner":$,"--n-text-color-line-outer":v}}),n=c?M("progress",m(()=>e.status[0]),t,e):void 0;return{mergedClsPrefix:y,mergedIndicatorPlacement:u,gapDeg:g,cssVars:c?void 0:t,themeClass:n==null?void 0:n.themeClass,onRender:n==null?void 0:n.onRender}},render(){const{type:e,cssVars:u,indicatorTextColor:g,showIndicator:y,status:c,railColor:o,railStyle:t,color:n,percentage:d,viewBoxWidth:p,strokeWidth:f,mergedIndicatorPlacement:h,unit:l,borderRadius:b,fillBorderRadius:s,height:i,processing:x,circleGap:$,mergedClsPrefix:v,gapDeg:C,gapOffsetDegree:S,themeClass:R,$slots:P,onRender:D}=this;return D==null||D(),r("div",{class:[R,`${v}-progress`,`${v}-progress--${e}`,`${v}-progress--${c}`],style:u,"aria-valuemax":100,"aria-valuemin":0,"aria-valuenow":d,role:e==="circle"||e==="line"||e==="dashboard"?"progressbar":"none"},e==="circle"||e==="dashboard"?r(Y,{clsPrefix:v,status:c,showIndicator:y,indicatorTextColor:g,railColor:o,fillColor:n,railStyle:t,offsetDegree:this.offsetDegree,percentage:d,viewBoxWidth:p,strokeWidth:f,gapDegree:C===void 0?e==="dashboard"?75:0:C,gapOffsetDegree:S,unit:l},P):e==="line"?r(V,{clsPrefix:v,status:c,showIndicator:y,indicatorTextColor:g,railColor:o,fillColor:n,railStyle:t,percentage:d,processing:x,indicatorPlacement:h,unit:l,fillBorderRadius:s,railBorderRadius:b,height:i},P):e==="multiple-circle"?r(E,{clsPrefix:v,strokeWidth:f,railColor:o,fillColor:n,railStyle:t,viewBoxWidth:p,percentage:d,showIndicator:y,circleGap:$},P):null)}});export{Q as _};
