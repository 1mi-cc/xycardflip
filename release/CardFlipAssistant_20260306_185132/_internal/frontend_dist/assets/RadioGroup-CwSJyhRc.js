...
`,[R("splitor",`
 ...
 `)])]);function ve(e,o,t){var a;const n=[];let d=!1;for(let i=0;i<e.length;++i){const s=e[i],c=(a=s.type)===null||a===void 0?void 0:a.name;c==="RadioButton"&&(d=!0);const g=s.props;if(c!=="RadioButton"){n.push(s);continue}if(i===0)n.push(s);else{const v=n[n.length-1].props,m=o===v.value,b=v.disabled,x=o===g.value,p=g.disabled,C=(m?2:0)+(b?0:1),y=(x?2:0)+(p?0:1),z={[`${t}-radio-group__splitor--disabled`]:b,[`${t}-radio-group__splitor--checked`]:m},r={[`${t}-radio-group__splitor--disabled`]:p,[`${t}-radio-group__splitor--checked`]:x},l=C<y?r:z;n.push(E("div",{class:[`${t}-radio-group__splitor`,l]}),s)}}return{children:n,isButtonGroup:d}}const fe=Object.assign(Object.assign({},P.props),{name:String,value:[String,Number,Boolean],defaultValue:{type:[String,Number,Boolean],default:null},size:String,disabled:{type:Boolean,default:void 0},"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array]}),Re=ae({name:"RadioGroup",props:fe,setup(e){const o=k(null),{mergedSizeRef:t,mergedDisabledRef:a,nTriggerFormChange:n,nTriggerFormInput:d,nTriggerFormBlur:i,nTriggerFormFocus:s}=A(e),{mergedClsPrefixRef:c,inlineThemeDisabled:g,mergedRtlRef:v}=U(e),m=P("Radio","-radio-group",he,be,e,c),b=k(e.defaultValue),x=I(e,"value"),p=M(x,b);function C(u){const{onUpdateValue:f,"onUpdate:value":B}=e;f&&w(f,u),B&&w(B,u),b.value=u,n(),d()}function y(u){const{value:f}=o;f&&(f.contains(u.relatedTarget)||s())}function z(u){const{value:f}=o;f&&(f.contains(u.relatedTarget)||i())}de(j,{mergedClsPrefixRef:c,nameRef:I(e,"name"),valueRef:p,disabledRef:a,mergedSizeRef:t,doUpdateValue:C});const r=se("Radio",v,c),l=D(()=>{const{value:u}=t,{common:{cubicBezierEaseInOut:f},self:{buttonBorderColor:B,buttonBorderColorActive:G,buttonBorderRadius:L,buttonBoxShadow:N,buttonBoxShadowFocus:O,buttonBoxShadowHover:K,buttonColor:J,buttonColorActive:q,buttonTextColor:Q,buttonTextColorActive:W,buttonTextColorHover:X,opacityDisabled:Y,[H("buttonHeight",u)]:Z,[H("fontSize",u)]:ee}}=m.value;return{"--n-font-size":ee,"--n-bezier":f,"--n-button-border-color":B,"--n-button-border-color-active":G,"--n-button-border-radius":L,"--n-button-box-shadow":N,"--n-button-box-shadow-focus":O,"--n-button-box-shadow-hover":K,"--n-button-color":J,"--n-button-color-active":q,"--n-button-text-color":Q,"--n-button-text-color-hover":X,"--n-button-text-color-active":W,"--n-height":Z,"--n-opacity-disabled":Y}}),h=g?le("radio-group",D(()=>t.value[0]),l,e):void 0;return{selfElRef:o,rtlEnabled:r,mergedClsPrefix:c,mergedValue:p,handleFocusout:z,handleFocusin:y,cssVars:g?void 0:l,themeClass:h==null?void 0:h.themeClass,onRender:h==null?void 0:h.onRender}},render(){var e;const{mergedValue:o,mergedClsPrefix:t,handleFocusin:a,handleFocusout:n}=this,{children:d,isButtonGroup:i}=ve(ie(ue(this)),o,t);return(e=this.onRender)===null||e===void 0||e.call(this),E("div",{onFocusin:a,onFocusout:n,ref:"selfElRef",class:[`${t}-radio-group`,this.rtlEnabled&&`${t}-radio-group--rtl`,this.themeClass,i&&`${t}-radio-group--button-group`],style:this.cssVars},d)}});export{Re as _,be as a,xe as r,Ce as s};
