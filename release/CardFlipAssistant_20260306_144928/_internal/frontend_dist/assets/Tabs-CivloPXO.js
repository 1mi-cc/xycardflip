import{k as ee,D as c,r as A,aV as ut,aW as vt,aX as Q,aY as ht,P as gt,aZ as xt,S as Pe,a1 as mt,a_ as yt,F as wt,av as St,a$ as Ct,n as Z,as as Rt,E as r,I as i,G as m,H as T,au as Tt,b0 as ne,aM as ye,aN as oe,J as $t,K as We,s as ie,o as zt,L as Pt,M as j,a3 as Wt,ax as I,b1 as q,N as _t,b2 as Et,b3 as Lt,W as At,b4 as Bt,b5 as kt,Z as se,X as jt,ai as J}from"./index-DXgA_KCR.js";import{A as It}from"./Add-Czy1pgEA.js";import{c as we,a as Ht,o as Ot}from"./Popover-zg6PKoAW.js";import{u as Se}from"./use-compitable-Bxb-Gja3.js";import{u as Ft}from"./use-merged-state-BDx2SpxW.js";const Mt=we(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[we("&::-webkit-scrollbar",{width:0,height:0})]),Dt=ee({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=A(null);function n(d){!(d.currentTarget.offsetWidth<d.currentTarget.scrollWidth)||d.deltaY===0||(d.currentTarget.scrollLeft+=d.deltaY+d.deltaX,d.preventDefault())}const s=ut();return Mt.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:Ht,ssr:s}),Object.assign({selfRef:e,handleWheel:n},{scrollTo(...d){var y;(y=e.value)===null||y===void 0||y.scrollTo(...d)}})},render(){return c("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var Nt=/\s/;function Vt(e){for(var n=e.length;n--&&Nt.test(e.charAt(n)););return n}var Xt=/^\s+/;function Ut(e){return e&&e.slice(0,Vt(e)+1).replace(Xt,"")}var Ce=NaN,Gt=/^[-+]0x[0-9a-f]+$/i,Yt=/^0b[01]+$/i,Kt=/^0o[0-7]+$/i,qt=parseInt;function Re(e){if(typeof e=="number")return e;if(vt(e))return Ce;if(Q(e)){var n=typeof e.valueOf=="function"?e.valueOf():e;e=Q(n)?n+"":n}if(typeof e!="string")return e===0?e:+e;e=Ut(e);var s=Yt.test(e);return s||Kt.test(e)?qt(e.slice(2),s?2:8):Gt.test(e)?Ce:+e}var le=function(){return ht.Date.now()},Jt="Expected a function",Zt=Math.max,Qt=Math.min;function ea(e,n,s){var u,d,y,v,f,x,h=0,g=!1,_=!1,E=!0;if(typeof e!="function")throw new TypeError(Jt);n=Re(n)||0,Q(s)&&(g=!!s.leading,_="maxWait"in s,y=_?Zt(Re(s.maxWait)||0,n):y,E="trailing"in s?!!s.trailing:E);function w(b){var R=u,F=d;return u=d=void 0,h=b,v=e.apply(F,R),v}function $(b){return h=b,f=setTimeout(W,n),g?w(b):v}function C(b){var R=b-x,F=b-h,U=n-R;return _?Qt(U,y-F):U}function P(b){var R=b-x,F=b-h;return x===void 0||R>=n||R<0||_&&F>=y}function W(){var b=le();if(P(b))return z(b);f=setTimeout(W,C(b))}function z(b){return f=void 0,E&&u?w(b):(u=d=void 0,v)}function O(){f!==void 0&&clearTimeout(f),h=0,u=x=d=f=void 0}function L(){return f===void 0?v:z(le())}function p(){var b=le(),R=P(b);if(u=arguments,d=this,x=b,R){if(f===void 0)return $(x);if(_)return clearTimeout(f),f=setTimeout(W,n),w(x)}return f===void 0&&(f=setTimeout(W,n)),v}return p.cancel=O,p.flush=L,p}var ta="Expected a function";function aa(e,n,s){var u=!0,d=!0;if(typeof e!="function")throw new TypeError(ta);return Q(s)&&(u="leading"in s?!!s.leading:u,d="trailing"in s?!!s.trailing:d),ea(e,n,{leading:u,maxWait:n,trailing:d})}const fe=gt("n-tabs"),_e={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]},ba=ee({__TAB_PANE__:!0,name:"TabPane",alias:["TabPanel"],props:_e,slots:Object,setup(e){const n=Pe(fe,null);return n||xt("tab-pane","`n-tab-pane` must be placed inside `n-tabs`."),{style:n.paneStyleRef,class:n.paneClassRef,mergedClsPrefix:n.mergedClsPrefixRef}},render(){return c("div",{class:[`${this.mergedClsPrefix}-tab-pane`,this.class],style:this.style},this.$slots)}}),ra=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},Rt(_e,["displayDirective"])),be=ee({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:ra,setup(e){const{mergedClsPrefixRef:n,valueRef:s,typeRef:u,closableRef:d,tabStyleRef:y,addTabStyleRef:v,tabClassRef:f,addTabClassRef:x,tabChangeIdRef:h,onBeforeLeaveRef:g,triggerRef:_,handleAdd:E,activateTab:w,handleClose:$}=Pe(fe);return{trigger:_,mergedClosable:Z(()=>{if(e.internalAddable)return!1;const{closable:C}=e;return C===void 0?d.value:C}),style:y,addStyle:v,tabClass:f,addTabClass:x,clsPrefix:n,value:s,type:u,handleClose(C){C.stopPropagation(),!e.disabled&&$(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){E();return}const{name:C}=e,P=++h.id;if(C!==s.value){const{value:W}=g;W?Promise.resolve(W(e.name,s.value)).then(z=>{z&&h.id===P&&w(C)}):w(C)}}}},render(){const{internalAddable:e,clsPrefix:n,name:s,disabled:u,label:d,tab:y,value:v,mergedClosable:f,trigger:x,$slots:{default:h}}=this,g=d??y;return c("div",{class:`${n}-tabs-tab-wrapper`},this.internalLeftPadded?c("div",{class:`${n}-tabs-tab-pad`}):null,c("div",Object.assign({key:s,"data-name":s,"data-disabled":u?!0:void 0},mt({class:[`${n}-tabs-tab`,v===s&&`${n}-tabs-tab--active`,u&&`${n}-tabs-tab--disabled`,f&&`${n}-tabs-tab--closable`,e&&`${n}-tabs-tab--addable`,e?this.addTabClass:this.tabClass],onClick:x==="click"?this.activateTab:void 0,onMouseenter:x==="hover"?this.activateTab:void 0,style:e?this.addStyle:this.style},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),c("span",{class:`${n}-tabs-tab__label`},e?c(wt,null,c("div",{class:`${n}-tabs-tab__height-placeholder`}," "),c(St,{clsPrefix:n},{default:()=>c(It,null)})):h?h():typeof g=="object"?g:yt(g??s)),f&&this.type==="card"?c(Ct,{clsPrefix:n,class:`${n}-tabs-tab__close`,onClick:this.handleClose,disabled:u}):null))}}),na=r("tabs",`
