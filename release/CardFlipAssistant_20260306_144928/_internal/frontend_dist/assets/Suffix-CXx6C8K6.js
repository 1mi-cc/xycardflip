...
`,[s(">",[n("clear",`
 ...
 `,[u({originalTransform:"translateX(-50%) translateY(-50%)",left:"50%",top:"50%"})])])]),x=a({name:"BaseClear",props:{clsPrefix:{type:String,required:!0},show:Boolean,onClear:Function},setup(r){return h("-base-clear",L,w(r,"clsPrefix")),{handleMouseDown(l){l.preventDefault()}}},render(){const{clsPrefix:r}=this;return e("div",{class:`${r}-base-clear`},e(f,null,{default:()=>{var l,o;return this.show?e("div",{key:"dismiss",class:`${r}-base-clear__clear`,onClick:this.onClear,onMousedown:this.handleMouseDown,"data-clear":!0},t(this.$slots.icon,()=>[e(i,{clsPrefix:r},{default:()=>e(p,null)})])):e("div",{key:"icon",class:`${r}-base-clear__placeholder`},(o=(l=this.$slots).placeholder)===null||o===void 0?void 0:o.call(l))}}))}}),b=a({name:"InternalSelectionSuffix",props:{clsPrefix:{type:String,required:!0},showArrow:{type:Boolean,default:void 0},showClear:{type:Boolean,default:void 0},loading:{type:Boolean,default:!1},onClear:Function},setup(r,{slots:l}){return()=>{const{clsPrefix:o}=r;return e(C,{clsPrefix:o,class:`${o}-base-suffix`,strokeWidth:24,scale:.85,show:r.loading},{default:()=>r.showArrow?e(x,{clsPrefix:o,show:r.showClear,onClear:r.onClear},{placeholder:()=>e(i,{clsPrefix:o,class:`${o}-base-suffix__arrow`},{default:()=>t(l.default,()=>[e(v,null)])})}):null})}}});export{g as E,b as N,x as a};
